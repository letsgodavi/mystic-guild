            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                    ...
                    <div className="relative z-10 mt-8 flex items-center justify-between">
                         <span className="text-xs text-slate-500 group-hover:text-white transition-colors">Go to Boss Schedule &rarr;</span>
...
export default function MysticHub() {
  ...
  const [activeTab, setActiveTab] = useState<'LOUNGE' | 'PROFILE' | 'INTEL' | 'BOSS_TIME' | 'COMPARE' | 'ORACLE'>('LOUNGE');
